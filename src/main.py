...
# Novo endpoint para a rota raiz  
@app.route('/', methods=['GET'])  
def root():  
    return jsonify({"message": "Servidor funcionando! Utilize /health para verificar o status."}), 200  

# Função para executar o aplicativo Flask  
def run_app():  
...
def get_bitcoin_price_binance():  
    """Obtém o preço atual do Bitcoin da API da Binance."""  
